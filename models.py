...
class Net2(nn.Module):
    ...
    def __init__(self):
        super(Net, self).__init__()  # Initialize the superclass (nn.Module) constructor.
        ###***************************
        self.conv1 = nn.Conv2d(1, 32, kernel_size=3,bias = False)  # First convolutional layer: 1 input channel, 32 output channels, 3x3 kernel.
        self.conv2 = nn.Conv2d(32, 64, kernel_size=3,bias = False)  # Second convolutional layer: 32 input channels, 64 output channels, 3x3 kernel.
        self.conv3 = nn.Conv2d(64, 128, kernel_size=3,bias = False)  # Third convolutional layer: 64 input channels, 128 output channels, 3x3 kernel.
        self.conv4 = nn.Conv2d(128, 256, kernel_size=3,bias = False)  # Fourth convolutional layer: 128 input channels, 256 output channels, 3x3 kernel.
        self.fc1 = nn.Linear(4096, 50,bias = False)  # First fully connected layer: 4*4*256 input features, 50 output features; this takes the flatten output of conv4 so 320 is wrong dimension
        self.fc2 = nn.Linear(50, 10,bias = False)  # Second fully connected layer: 50 input features, 10 output features (e.g., for 10 classes).
        ##****************************
